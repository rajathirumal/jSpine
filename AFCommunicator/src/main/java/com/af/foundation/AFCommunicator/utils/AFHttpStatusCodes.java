...
package com.af.foundation.AFCommunicator.utils;

public enum AFHttpStatusCodes {
	...
	private AFHttpStatusCodes(int value, String description) {
		this.value = value;
	...
	public static AFHttpStatusCodes getByValue(int value) {
		AFHttpStatusCodes[] var1 = values();
		int var2 = var1.length;

		for (int var3 = 0; var3 < var2; ++var3) {
			AFHttpStatusCodes status = var1[var3];
