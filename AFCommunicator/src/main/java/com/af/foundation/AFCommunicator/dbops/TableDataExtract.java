...
public class TableDataExtract {
	...
	private static int whichCategory(int type) {
		...
		default:
			throw new AFCommonExceptions("Unable to determint the Data type of :" + type);
		}
	}
	...
	public List<JSONObject> extractDataFromResultSet() {
		...
		if (this.getResultSet() == null) {
			throw new AFCommonExceptions("TableDataExtract Error: Result set is null!");
		} else {
			try {
				...
				throw new AFCommonExceptions(var15.getMessage());
			}
		}
	}
}