...
package com.spine.common.converters;
...
public class Translate {
   ...
   public String getDisplayOrderQuerry() {
      String var1 = SpineConfiguration.DB_TYPE;
      byte var2 = -1;
      ...
      default:
         ...
         default:
            throw new SpineCommonExceptions("Un supporting DB type: " + SpineConfiguration.DB_TYPE);
         }
      }
   }
   ...
   public String queryStringToSQL(String request) {
      if (!request.isBlank() && !request.isEmpty()) {
         ...
         try {
            ...
            if (parts.length < 3) {
               throw new SpineCommonExceptions("Invalid query string : " + request);
            }
            ...
            case 1:
               ...
               break;
            default:
               throw new SpineCommonExceptions("Invalid operation " + parts[0] + ", Must be one of " + String.valueOf(this.QUERY_TYPES));
            }
         ...
         throw new SpineCommonExceptions("Empty query string");
      }
   }
