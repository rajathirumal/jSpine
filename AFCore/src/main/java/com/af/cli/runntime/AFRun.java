...
import com.af.foundation.AFCommon.classLoader.AFClassLoader;
...
public class AFRun {
	 ...
	 */
	private void init() {
		this.defaultPackageName = AFConfiguration.DEFAULT_PACKAGE;
		AFClassLoader afClassLoader = new AFClassLoader();
	...
	private void run(String[] args) {
		...
		try {
			...
			System.out.println("Flow execution successful");
		...
		System.out.println("Running your flow");
	}
